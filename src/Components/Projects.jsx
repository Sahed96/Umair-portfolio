...
const Projects = () => {
  return (
    <div className="mt-20 poppins">
      ...
      <div>
        <div className=" gap-6 mt-14 justify-center flex">
        ...
        <div className="grid mb-10 lg:grid-cols-3 grid-cols-1 ml-6 gap-10 mt-14 justify-center mx-auto">
          <div className="relative w-[445px] h-[489px] rounded-[12px] bg-[#FFEBDB]">
            <img className="absolute pr-7 right-0" src={design2} alt="" />
            <img className="absolute -bottom-1 pl-10" src={design1} alt="" />
            <div className="absolute -bottom-36 left-0 pb-10">
          ...
          <div className="relative w-[445px] h-[489px] rounded-[12px] bg-[#FFEBDB]">
            <img className="absolute pr-7 right-0" src={design4} alt="" />
            <img className="absolute -bottom-1 pl-10" src={design3} alt="" />
            <div className="absolute -bottom-36 left-0 pb-10">
              <p className="text-[#FD6F00] font-poppins text-[19px] font-normal leading-normal tracking-[0.57px]">
                Web Design
              </p>
          ...
          <div className="relative w-[445px] h-[489px] rounded-[12px] bg-[#FFEBDB]">
            <img className="absolute pr-7 right-0" src={design6} alt="" />
            <img className="absolute -bottom-1 pl-10" src={design5} alt="" />
            <div className="absolute -bottom-36 left-0 pb-10">
              <p className="text-[#FD6F00] font-poppins text-[19px] font-normal leading-normal tracking-[0.57px]">
                Web Design
              </p>
